...
- If the project uses Gradle, run `./gradlew bootRun` to start the application.
- If the project uses Gradle, run `./gradlew test` to run all tests.
- If the project uses Gradle, run `./gradlew test --tests com.example.ClassName` to run a specific test class.
- If the project uses Gradle, run `./gradlew test --tests com.example.ClassName.methodName` to run a specific test method.
- If the project uses Gradle, run `./gradlew jacocoTestReport` to generate a code coverage report.
