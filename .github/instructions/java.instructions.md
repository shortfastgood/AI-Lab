...
- Use `@NonNull` and `@Nullable` annotations to clarify nullability expectations.
- Use `@Override` annotation for overridden methods to improve readability and catch errors.
- Use `@FunctionalInterface` for functional interfaces to ensure they meet the requirements.
- Generate code for Java 21 or higher
